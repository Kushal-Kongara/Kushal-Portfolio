    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto font-bold">
          Currently looking for a full-time role. Open to roles like Full Stack
          Developer, Frontend Developer, or Software Engineer. If you have an
          exciting opportunity or just want to say hi, feel free to reach out!
        </p>
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:kkushal2509@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    kkushal2509@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground hover:text-primary transition-colors">
                    San Jose, CA, USA (Open to relocation)
                  </p>
                </div>
              </div>
            </div>
